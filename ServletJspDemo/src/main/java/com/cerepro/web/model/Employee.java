...
public class Employee {
	...
	public void setName(String name) {
	 ...
	 public void setVacationDays(int intvacationDays) { this.vacationDays = vacationDays; }
	...
	public String toString() {
		return "Employee [ id =" + id + " name=" + name + " password=" + password +  " vacationDays=" + vacationDays + "vacationStart=" + vacationStart + ", vacationEnd=" + vacationEnd +"]";
	}
